const Search = () => {
  return (
    <div
      className={`flex h-[48px] w-full md:w-[300px] items-center gap-[8px] flex-[1 1 0] bg-white dark:bg-transparent rounded-[24px] border border-[#DADDD] dark:border-[#555] pl-[16px] pr-1 overflow-hidden focus-within:outline focus-within:outline-[#34CAA5]`}
    >
      <svg
        width="18"
        height="18"
      ...
      <input
        type="text"
        name="search"
        className="w-full dark:text-white text-[14px] focus:outline-none"
